  ...
  return (
    <div className="hc-layout">
      ...
      <header className="hc-header" role="banner">
        <div className={`${containerClassName} hc-header-inner`}>
          <Link to="/" className="hc-brand" aria-label="ELIXRA home">
            ...
            <div className="hc-brand-text">
              <div className="hc-brand-title">ELIXRA</div>
              <div className="hc-brand-subtitle">Home Health Care</div>
            </div>
          </Link>
      ...
      {!isPublicPage && (
        <footer className="hc-footer-minimal" role="contentinfo">
          <div className="container">
            <span>© {new Date().getFullYear()} ELIXRA Home Health Care. All rights reserved.</span>
          </div>
        </footer>
      )}
    </div>
