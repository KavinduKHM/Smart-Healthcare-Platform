...
/**
 * Validates incoming Bearer tokens by calling auth-service /api/auth/validate.
 * If valid, populates Spring SecurityContext with username + roles.
 */
@Component
public class AuthServiceAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // auth-service responded with 4xx/5xx; treat as unauthenticated
